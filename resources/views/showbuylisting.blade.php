            ...
            <div class="card">
                <div class="card-body">
                    <div class ="card-header text-center"><span class="float-right">
                        <a href="/" class="btn btn-outline-dark btn-xs">Back</a></span><h3>Buy Products</h3></div>
                        ...
                        <table class ='table table-hover'>
                            ...
                            @foreach($listings as $listing)
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle"><a class="pull-right btn btn-outline-primary" href="/buylistings/{{$listing->id}}/edit">Edit</a></td>
